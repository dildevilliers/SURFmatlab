classdef CBFP < FarFieldExpansion
    ...
    properties
        tol (1,1) {mustBeReal, mustBeFinite, mustBePositive}
        iFM (1,:) {mustBeReal, mustBeFinite, mustBePositive}
    ...
    methods
        function obj = CBFP(FFobj,tol,iFM)
            % function obj = CBFP(FFobj,tol,iFM)
            %
    ...
    methods (Static)
        function Wout = farField2Coeffs(FFobj,CBFPobj,tol,iBasis)
            % Wout = farField2Coefficients(FFobj,CBFPobj,tol,iBasis)
            %
            % Inputs:   FFobj   - Farfield object
            %           CBFPobj - CBFP object
            %           tol     - Tolerance
        ...
        function FFobj = coeffs2FarField(CBFPobj,W,tol,iBasis)
            % function FFobj = expansion2FarField(CBFPobj,W,tol,iBasis)
            %
