...
FF = FarField.readFEKOffe(['D:\SURFmatlab\@FarField\patch']);
...
figure
FF.plot('plotType','cartesian','output','Directivity','outputType','mag','step',1,'showGrid',true,'dynamicRange_dB',30,'cutConstant','x','cutValue',0), hold on;
