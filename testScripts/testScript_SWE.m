...
swe3 = SWE([inf.*ones(size(th)) th ph], [4 4], 'MNmax');
...
figure
subplot(3,1,1)
plot(FF1-FF_swe1,'plotType','2D','outputType','mag','step',1,'showGrid',true);
subplot(3,1,2)
plot(FF1-FF_swe2,'plotType','2D','outputType','mag','step',1,'showGrid',true);
subplot(3,1,3)
plot(FF1-FF_swe3,'plotType','2D','outputType','mag','step',1,'showGrid',true);

%CST farfield (11 frequencies)
figure
subplot(3,1,1)
plot(FF2-FF_swe4,'plotType','2D','outputType','mag','step',1,'showGrid',true);
subplot(3,1,2)
plot(FF2-FF_swe5,'plotType','2D','outputType','mag','step',1,'showGrid',true);
subplot(3,1,3)
plot(FF2-FF_swe6,'plotType','2D','outputType','mag','step',1,'showGrid',true);
